    ...
    #define COMMAND_SESSION_MESSAGE_BOARD_LIST     	0xB4

    #define DATA_REQUEST_MESSAGE_TEMPERATURE   		0xB5
    #define DATA_REQUEST_MESSAGE_VOLTAGE     		0xB6
    #define DATA_REQUEST_MESSAGE_CURRENT     		0xB7
    #define DATA_REQUEST_MESSAGE_CV     		0xB8
    #define DATA_REQUEST_MESSAGE_SIMULATED_CV  		0xB9
    #define DATA_REQUEST_MESSAGE_SIMULATED_VOLTAGE  	0xBA
    #define DATA_REQUEST_MESSAGE_SIMULATED_CURRENT  	0xBB
    #define DATA_REQUEST_MESSAGE_SIMULATED_TEMPERATURE  0xBC
